  ...
  return <section className="py-20 px-6 max-w-2xl mx-auto">
      <div className="space-y-12">
        ...
        <div className="space-y-8 text-center">
          <p className="text-cosmic text-lg leading-relaxed whitespace-pre-line">The following link holds what is moving through me these days - a living reflection of focus, evolving emphasis & the quiet momentum of unfolding work.</p>
